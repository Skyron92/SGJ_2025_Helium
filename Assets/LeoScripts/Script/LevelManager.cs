...
public class LevelManager : MonoBehaviour {
    ...
    private Case[,] _gridLevel2 = new Case[16, 16] {
        {new Forest(0,0), new Water(0,1),new Forest(0,2),new Forest(0,3),new Forest(0,4),new Forest(0,5), new Forest(0,6),new Building(0,7),new Building(0,8),new Building(0,9),new Building(0,10),new Building(0,11),new Forest(0,12),new Forest(0,13),new Forest(0,14),new Forest(0,15)},
        {new Forest(1,0), new Water(1,1),new Forest(1,2),new Forest(1,3),new Plaine(1,4),new Forest(1,5), new Forest(1,6),new Building(1,7),new Building(1,8),new Building(1,9),new Building(1,10),new Plaine(1,11),new Plaine(1,12),new Plaine(1,13),new Plaine(1,14),new Forest(1,15)},
        {new Forest(2,0), new Water(2,1),new Water(2,2),new Plaine(2,3),new Plaine(2,4),new Plaine(2,5), new Forest(2,6),new Forest(2,7),new Plaine(2,8),new Building(2,9),new Building(2,10),new Plaine(2,11),new Plaine(2,12),new Plaine(2,13),new Forest(2,14),new Forest(2,15)},
        {new Forest(3,0), new Forest(3,1),new Water(3,2),new Plaine(3,3),new Plaine(3,4),new Forest(3,5), new Plaine(3,6),new Plaine(3,7),new Plaine(3,8),new Forest(3,9),new Plaine(3,10),new Plaine(3,11),new Plaine(3,12),new Plaine(3,13),new Plaine(3,14),new Forest(3,15)},
        {new Forest(4,0), new Water(4,1),new Water(4,2),new Parking(4,3),new Plaine(4,4),new Forest(4,5), new Forest(4,6),new Plaine(4,7),new Plaine(4,8),new Forest(4,9),new Plaine(4,10),new Plaine(4,11),new Plaine(4,12),new Plaine(4,13),new Plaine(4,14),new Forest(4,15)},
        {new Forest(5,0), new Water(5,1),new Forest(5,2),new Forest(5,3),new Plaine(5,4),new Forest(5,5), new Forest(5,6),new Forest(5,7),new Forest(5,8),new Plaine(5,9),new Plaine(5,10),new Forest(5,11),new Plaine(5,12),new Plaine(5,13),new Forest(5,14),new Forest(5,15)},
        {new Water(6,0), new Water(6,1),new Forest(6,2),new House(6,3),new Forest(6,4),new Forest(6,5), new Plaine(6,6),new Plaine(6,7),new Forest(6,8),new Forest(6,9),new Forest(6,10),new Building(6,11),new Building(6,12),new Parking(6,13),new Building(6,14),new Forest(6,15)},
        {new Water(7,0), new Forest(7,1),new Forest(7,2),new Plaine(7,3),new Forest(7,4),new Forest(7,5), new Plaine(7,6),new Forest(7,7),new Plaine(7,8),new Forest(7,9),new Plaine(7,10),new Plaine(7,11),new Building(7,12),new Building(7,13),new Building(7,14),new Building(7,15)},
        {new Water(8,0), new Forest(8,1),new Forest(8,2),new Forest(8,3),new Forest(8,4),new Forest(8,5), new Forest(8,6),new Forest(8,7),new Forest(8,8),new Forest(8,9),new Plaine(8,10),new Forest(8,11),new Building(8,12),new Building(8,13),new Building(8,14),new Building(8,15)},
        {new Water(9,0), new Water(9,1),new Forest(9,2),new Forest(9,3),new Forest(9,4),new Parking(9,5), new Plaine(9,6),new Forest(9,7),new Plaine(9,8),new Forest(9,9),new Plaine(9,10),new Forest(9,11),new Building(9,12),new Building(9,13),new Building(9,14),new Building(9,15)},
        {new Forest(10,0), new Water(10,1),new Forest(10,2),new Plaine(10,3),new Forest(10,4),new Plaine(10,5), new Plaine(10,6),new Forest(10,7),new Plaine(10,8),new Forest(10,9),new Plaine(10,10),new Building(10,11),new Parking(10,12),new Building(10,13),new Building(10,14),new Building(10,15)},
        {new Plaine(11,0), new Water(11,1),new Plaine(11,2),new Plaine(11,3),new Parking(11,4),new Plaine(11,5), new Plaine(11,6),new Forest(11,7),new Plaine(11,8),new Plaine(11,9),new Plaine(11,10),new Building(11,11),new Building(11,12),new Building(11,13),new Parking(11,14),new Building(11,15)},
        {new Forest(12,0), new Water(12,1),new Forest(12,2),new Forest(12,3),new Forest(12,4),new Plaine(12,5), new Forest(12,6),new Forest(12,7),new House(12,8),new Plaine(12,9),new Forest(12,10),new Building(12,11),new Building(12,12),new Building(12,13),new Building(12,14),new Building(12,15)},
