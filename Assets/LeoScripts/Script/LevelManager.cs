...
public class LevelManager : MonoBehaviour {
    ...
    private Case[,] _gridLevel1 = new Case[16, 16] {
        {new Forest(0,0), new Forest(0,1),new Forest(0,2),new Forest(0,3),new Water(0,4),new Forest(0,5), new Forest(0,6),new Forest(0,7),new Forest(0,8),new Forest(0,9),new Forest(0,10),new Plaine(0,11),new Forest(0,12),new Forest(0,13),new Forest(0,14),new Forest(0,15)},
        {new Forest(1,0), new Forest(1,1),new Forest(1,2),new Forest(1,3),new Water(1,4),new Water(1,5), new Forest(1,6),new Forest(1,7),new Forest(1,8),new Plaine(1,9),new Plaine(1,10),new Plaine(1,11),new Plaine(1,12),new Plaine(1,13),new Plaine(1,14),new Forest(1,15)},
        {new Forest(2,0), new Forest(2,1),new Plaine(2,2),new Plaine(2,3),new Plaine(2,4),new Water(2,5), new Forest(2,6),new Forest(2,7),new Plaine(2,8),new Plaine(2,9),new Forest(2,10),new Plaine(2,11),new Plaine(2,12),new Plaine(2,13),new Forest(2,14),new Forest(2,15)},
        {new Forest(3,0), new Forest(3,1),new Plaine(3,2),new Plaine(3,3),new Forest(3,4),new Water(3,5), new Water(3,6),new Water(3,7),new Forest(3,8),new Plaine(3,9),new Plaine(3,10),new Forest(3,11),new Plaine(3,12),new Plaine(3,13),new Plaine(3,14),new Forest(3,15)},
        {new Forest(4,0), new Plaine(4,1),new Plaine(4,2),new Parking(4,3),new Plaine(4,4),new Forest(4,5), new Forest(4,6),new Water(4,7),new Water(4,8),new Forest(4,9),new Plaine(4,10),new Plaine(4,11),new Plaine(4,12),new Plaine(4,13),new Plaine(4,14),new Forest(4,15)},
        {new Forest(5,0), new Plaine(5,1),new Plaine(5,2),new Forest(5,3),new Plaine(5,4),new Plaine(5,5), new Forest(5,6),new Plaine(5,7),new Water(5,8),new Plaine(5,9),new Plaine(5,10),new Forest(5,11),new Plaine(5,12),new Plaine(5,13),new Forest(5,14),new Forest(5,15)},
        {new Plaine(6,0), new Plaine(6,1),new Plaine(6,2),new Forest(6,3),new Plaine(6,4),new Plaine(6,5), new Plaine(6,6),new Plaine(6,7),new Water(6,8),new Plaine(6,9),new Forest(6,10),new Plaine(6,11),new Plaine(6,12),new Plaine(6,13),new Forest(6,14),new Forest(6,15)},
        {new Plaine(7,0), new Plaine(7,1),new Plaine(7,2),new Plaine(7,3),new Forest(7,4),new Forest(7,5), new Plaine(7,6),new Forest(7,7),new Water(7,8),new Water(7,9),new Water(7,10),new Plaine(7,11),new Plaine(7,12),new Plaine(7,13),new Plaine(7,14),new Forest(7,15)},
        {new Plaine(8,0), new Plaine(8,1),new Plaine(8,2),new Plaine(8,3),new Plaine(8,4),new Forest(8,5), new Plaine(8,6),new Plaine(8,7),new Forest(8,8),new Forest(8,9),new Water(8,10),new Forest(8,11),new Plaine(8,12),new Plaine(8,13),new Plaine(8,14),new Forest(8,15)},
        {new Plaine(9,0), new Plaine(9,1),new Parking(9,2),new Plaine(9,3),new Plaine(9,4),new Parking(9,5), new Plaine(9,6),new Forest(9,7),new Plaine(9,8),new Forest(9,9),new Water(9,10),new Forest(9,11),new Plaine(9,12),new Plaine(9,13),new Plaine(9,14),new Forest(9,15)},
        {new Plaine(10,0), new Plaine(10,1),new Plaine(10,2),new Plaine(10,3),new Plaine(10,4),new Plaine(10,5), new Plaine(10,6),new Forest(10,7),new Plaine(10,8),new Forest(10,9),new Water(10,10),new Water(10,11),new Plaine(10,12),new Plaine(10,13),new Plaine(10,14),new Forest(10,15)},
        {new Plaine(11,0), new Plaine(11,1),new Plaine(11,2),new Plaine(11,3),new Parking(11,4),new Plaine(11,5), new Plaine(11,6),new Plaine(11,7),new Plaine(11,8),new Plaine(11,9),new Plaine(11,10),new Water(11,11),new Forest(11,12),new Forest(11,13),new Plaine(11,14),new Forest(11,15)},
        {new Plaine(12,0), new Plaine(12,1),new Parking(12,2),new Plaine(12,3),new Plaine(12,4),new Plaine(12,5), new Plaine(12,6),new Plaine(12,7),new Plaine(12,8),new Plaine(12,9),new Forest(12,10),new Water(12,11),new Water(12,12),new Water(12,13),new Forest(12,14),new Forest(12,15)},
        {new Forest(13,0), new Plaine(13,1),new Plaine(13,2),new Plaine(13,3),new Plaine(13,4),new Parking(13,5), new Plaine(13,6),new Forest(13,7),new Plaine(13,8),new Plaine(13,9),new Plaine(13,10),new Plaine(13,11),new Forest(13,12),new Water(13,13),new Forest(13,14),new Forest(13,15)},
        {new Forest(14,0), new Forest(14,1),new Plaine(14,2),new Forest(14,3),new Plaine(14,4),new Plaine(14,5), new Forest(14,6),new Forest(14,7),new Plaine(14,8),new Plaine(14,9),new Plaine(14,10),new Plaine(14,11),new Plaine(14,12),new Water(14,13),new Water(14,14),new Forest(14,15)},
